(defproject custman "0.1.0-SNAPSHOT"
  ...
  {:builds {:dev {:source-paths ["src/cljs" "src/cljc" "env/dev/cljs"]
                  :figwheel {:css-dirs ["resources/public/css"]             ;; watch and update CSS
                             :on-jsload "custman.dev/main"}
                  :compiler     {:main           "custman.dev"
  ...
  :profiles {:dev     {:repl-options {:init-ns          de.sveri.custman.user}
  ...
  :main de.sveri.custman.core

  :uberjar-name "custman.jar"
